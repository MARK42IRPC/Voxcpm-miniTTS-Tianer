...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_sid_text, hparams):
        ...
        self.symbol_to_id = {symbol: index for index, symbol in enumerate(hparams.symbols)}
    ...
    def get_text(self, text, word2ph, phone, tone, language_str, wav_path):
        phone, tone, language = cleaned_text_to_sequence(phone, tone, language_str, self.symbol_to_id)
        if self.add_blank:
